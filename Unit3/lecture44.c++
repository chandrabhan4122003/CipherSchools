c1x  A1 this is better algorithm 
c2x^2 A2 
x^2 >>>>>>x :: as size of x increses 
criteria for comparing find the no of executable code  eg kn1+k2(n-1)n/2 to find the value 
asymptotic analysis used 
...
"higher order increasing term " 10^5x<10^-2 x^2
n2<n3 
n2 is more efficient 
